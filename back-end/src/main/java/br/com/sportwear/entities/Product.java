...
public class Product implements Serializable {
    ...
    public final boolean equals(Object o) {
        ...
        return Objects.equals(getId(),
                product.getId()) && Objects.equals(getName(),
                product.getName()) && Objects.equals(getDescription(),
                product.getDescription()) && Objects.equals(getPrice(),
                product.getPrice()) && Objects.equals(getImgUrl(),
                product.getImgUrl()) && Objects.equals(getDate(),
                product.getDate()) && Objects.equals(getCategories(),
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(getImgUrl());
